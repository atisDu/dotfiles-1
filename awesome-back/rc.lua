...
terminal = "terminator --title='Terminator'"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "b", function () awful.spawn.with_shell("blueman-manager")    end,
              {description = "launch blueman-manager (Bluetooth Controls)", group = "applications"}),
